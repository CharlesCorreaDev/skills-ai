...
> **Official URL:** [https://foundryvtt.com/api/v12/](https://foundryvtt.com/api/v12/)  
> **Source:** Foundry Gaming LLC Client-Side API Documentation - Version 12

---

## 📌 Overview & Scope
Welcome to the comprehensive technical documentation for the client-side API of **Foundry Virtual Tabletop Version 12**.
...
- AmbientLightConfig - The Application responsible for configuring a single AmbientLight document within a parent Scene.
...
- FunctionTerm - A type of RollTerm used to apply a function.
...
- **API Reference:** [https://foundryvtt.com/api/v12/](https://foundryvtt.com/api/v12/)
