...
> **Official URL:** [https://foundryvtt.com/api/v10/](https://foundryvtt.com/api/v10/)  
> **Source:** Foundry Gaming LLC Client-Side API Documentation - Version 10

---

## 📌 Overview & Scope
Welcome to the comprehensive technical documentation for the client-side API of **Foundry Virtual Tabletop Version 10**.
...
- We will not provide deprecation periods
- We will make breaking changes at any point in a Version
...
Methods and properties marked @private should not be used or modified except by the class which defined them. For API users, this means that you should not reference or override this property. We may make breaking changes to the code for @private attributes without warning or advance notice, even in software versions which are marked "Stable".
...
Methods and properties which begin with a # are hard-private, and are not able to be accessed outside of their declaring class. This is enforced by Javascript itself - any attempt to read or write these will cause a syntax error.
MDN reference
...
- **API Reference:** [https://foundryvtt.com/api/v10/](https://foundryvtt.com/api/v10/)
